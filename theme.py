...
def inject_css():
    ...
    st.markdown(
        ...
        .sb-crest {{ display:flex; justify-content:center; margin-bottom:10px; filter:drop-shadow(0 2px 5px rgba(0,0,0,.25)); }}
        .sb-crest img {{ width:64px; height:64px; display:block; }}
